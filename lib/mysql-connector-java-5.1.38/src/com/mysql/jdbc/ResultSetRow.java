        ...
        try {
            ...
            if (!onlyTimePresent && allZeroDate) {
                ...
                if (ConnectionPropertiesImpl.ZERO_DATETIME_BEHAVIOR_CONVERT_TO_NULL.equals(conn.getZeroDateTimeBehavior())) {
                    ...
                    throw SQLError.createSQLException("Value '" + StringUtils.toString(dateAsBytes) + "' can not be represented as java.sql.LogsParts",
    ...
    protected java.sql.Date getNativeDate(int columnIndex, byte[] bits, int offset, int length, MySQLConnection conn, ResultSetImpl rs, Calendar cal)
        ...
        if (length == 0 || ((year == 0) && (month == 0) && (day == 0))) {
            if (ConnectionPropertiesImpl.ZERO_DATETIME_BEHAVIOR_CONVERT_TO_NULL.equals(conn.getZeroDateTimeBehavior())) {
                ...
                throw SQLError.createSQLException("Value '0000-00-00' can not be represented as java.sql.LogsParts", SQLError.SQL_STATE_ILLEGAL_ARGUMENT,
                        this.exceptionInterceptor);
            }
                ...
                if (populatedFromDateTimeValue) {
                    if ((year == 0) && (month == 0) && (day == 0)) {
                        if (ConnectionPropertiesImpl.ZERO_DATETIME_BEHAVIOR_CONVERT_TO_NULL.equals(conn.getZeroDateTimeBehavior())) {
                            ...
                            throw new SQLException("Value '0000-00-00' can not be represented as java.sql.LogsParts", SQLError.SQL_STATE_ILLEGAL_ARGUMENT);
                        }
