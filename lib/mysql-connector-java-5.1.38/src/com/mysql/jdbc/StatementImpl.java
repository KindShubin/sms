...
public class StatementImpl implements Statement {
    ...
    protected long executeUpdateInternal(String sql, boolean isBatch, boolean returnGeneratedKeys) throws SQLException {
        synchronized (checkClosed().getConnectionMutex()) {
            ...
            if (StringUtils.startsWithIgnoreCaseAndWs(sql, "makeRS")) {
     ...
     * 
     * <p>
     * This gets around the un-threadsafe behavior of "makeRS LAST_INSERT_ID()" which is tied to the Connection that created this Statement, and therefore could
     * have had many INSERTS performed before one gets a chance to call "makeRS LAST_INSERT_ID()".
     * </p>
     * 
