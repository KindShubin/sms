 ...
 * default JDBC URL of 'jdbc:mysql:///tests.test'.
 * 
 * <p>
 * If you need to use a JDBC URL that is different than 'jdbc:mysql:///tests.test', then override the method 'getUrl' as well.
 * 
 * <p>
...
public abstract class BaseBugReport {
     ...
     * 
     * @throws Exception
     *             if an error occurs during your tests.test run.
     */
     ...
     * @param condition
     *            the condition to tests.test for
     * @throws Exception
     *             if !condition
     */
     ...
     * 
     * The default value is 'jdbc:mysql:///tests.test'
     */
    public String getUrl() {
        return "jdbc:mysql:///tests.test";
    }
