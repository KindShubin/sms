...
/**
 * Dumps the timezone of the MySQL server represented by the JDBC url given on the commandline (or localhost/tests.test if none provided).
 */
public class TimezoneDump {
    private static final String DEFAULT_URL = "jdbc:mysql:///tests.test";
