...
public class MysqlIO {
    ...
    /**
     * iSend a command to the MySQL server If data is to be sent with command,
    ...
    /**
     * iSend a query stored in a packet directly to the server.
     * 
     * @param callingStatement
     * @param resultSetConcurrency
    ...
    final ResultSetInternalMethods sqlQueryDirect(StatementImpl callingStatement, String query, String characterEncoding, Buffer queryPacket, int maxRows,
        ...
        try {
            ...
            // iSend query command and sql query string
