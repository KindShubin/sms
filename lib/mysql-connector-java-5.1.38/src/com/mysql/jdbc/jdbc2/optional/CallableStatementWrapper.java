...
public class CallableStatementWrapper extends PreparedStatementWrapper implements CallableStatement {
     ...
     * (non-Javadoc)
     * 
     * @see java.sql.CallableStatement#setDate(java.lang.String, java.sql.LogsParts)
     */
     ...
     * (non-Javadoc)
     * 
     * @see java.sql.CallableStatement#setDate(java.lang.String, java.sql.LogsParts, java.util.Calendar)
     */
