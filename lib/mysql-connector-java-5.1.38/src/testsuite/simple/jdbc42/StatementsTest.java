...
public class StatementsTest extends BaseTestCase {
    ...
    /**
     * Test shared tests.test data validity.
     */
     ...
     * Validate new methods as well as support for the types java.time.Local[LogsParts][Time] and java.time.Offset[LogsParts]Time.
     */
    public void testPrepStmtSetObjectAndNewSupportedTypes() throws Exception {
        /*
         * Objects java.time.Local[LogsParts][Time] are supported via conversion to/from java.sql.[LogsParts|Time|Timestamp].
         */
        ...
        /*
         * Objects java.time.Offset[LogsParts]Time are supported via conversion to *CHAR or serialization.
         */
    ...
    /**
     * Helper method for *SetObject* tests.
     * Validate the tests.test data contained in the given ResultSet with following structure:
     * 1 - `id` INT
     * 2 - `d` DATE (or any kind of *CHAR)
     * 3 - `t` TIME (or any kind of *CHAR)
     * 4 - `dt` DATETIME (or any kind of *CHAR)
     * 5 - `ts` TIMESTAMP (or any kind of *CHAR)
     * 
     * Additionally validate support for the types java.time.Local[LogsParts][Time] in ResultSet.getObject().
     * 
     * @param tableName
     ...
     * 5 - `odt2` BLOB
     * 
     * Additionally validate support for the types java.time.Offset[LogsParts]Time in ResultSet.getObject().
     * 
     * @param tableName
     * @param expectedRowCount
     * @throws Exception
    ...
    private void validateTestDataOffsetDTTypes(String tableName, int expectedRowCount) throws Exception {
        Connection testConn = getConnectionWithProps("autoDeserialize=true"); // Offset[LogsParts]Time are supported via object serialization too.
