...
public class ServerControllerTest extends BaseTestCase {
    ...
    public ServerControllerTest(String name) {
        ...
        this.baseDir = System.getProperty("com.mysql.jdbc.tests.test.ServerController.basedir");
    }
     ...
     * Demonstrates usage of the ServerController class.
     * 
     * This tests.test is only run if the property
     * 'com.mysql.jdbc.tests.test.ServerController.basedir' is set.
     * 
     * @throws Exception
     *             if an error occurs.
     */
