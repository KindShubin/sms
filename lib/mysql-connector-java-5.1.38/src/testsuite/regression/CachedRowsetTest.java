...
public class CachedRowsetTest extends BaseTestCase {
    ...
    public void testBug5188() throws Exception {
        ...
        this.stmt.executeUpdate("INSERT INTO testBug5188(datafield) values('tests.test data stuff !')");
        ...
        assertEquals("tests.test data stuff !", cachedRowSet.getString("datafield"));
