...
public class ConnectionRegressionTest extends BaseTestCase {
     ...
     * 
     * Bug observed only with JDBC4 classes. This tests.test is duplicated in testsuite.regression.ConnectionRegressionTest#testBug75168().
     ...
     * 
     * This tests.test is duplicated in testuite.regression.ConnectionRegressionTest.testBug20685022().
     * 
     * @throws Exception
