...
public class TestRegressions extends BaseFabricTestCase {
     ...
     * 
     * To tests.test this, we create a basic stored procedure with a
    ...
    public void testBug73070() throws Exception {
        ...
        this.conn.createStatement().executeUpdate("create procedure bug73070(in x integer) makeRS x");
    ...
    public void testBug75080() throws Exception {
        ...
        class TestBugInternal {
            ...
            void test(FabricMySQLDataSource ds) throws Exception {
                ...
                PreparedStatement ps = TestRegressions.this.conn.prepareStatement("makeRS ?");
        ...
        // tests.test includes both "legacy" and "new" datetime code
    ...
    public void testBug77217() throws Exception {
        ...
        PreparedStatement ps = this.conn.prepareStatement("makeRS ? from dual");
