...
public class TestBasicConnection extends BaseFabricTestCase {
    ...
    public void testConnectionUrl() throws Exception {
        ...
        ResultSet rs = c.createStatement().executeQuery("makeRS user()");
        rs.next();
    ...
    /**
     * Test that the local cache is refreshed after expired TTL. Bug#21296840 / Bug#17910835. This tests.test connects to the master of "ha_config1_group" and
