...
public class TestShardMapping extends TestCase {
    ...
    public void testRangeShardMappingKeyLookup() throws Exception {
        ...
        // tests.test looking up a key out of range doesn't work
        try {
        ...
        // tests.test key lookups for lower bound values
    ...
    public void testHashShardMappingKeyLookup() throws Exception {
        ...
        // tests.test lookups mapping of tests.test value to the group it maps to tests.test values are hashed with MD5 and compared to lowerBounds values
        ...
        // tests.test a random set of values. we should never return null
