...
/**
 * Simple performance testing unit tests.test.
 */
public class LoadStorePerfTest extends BasePerfTest {
    ...
    public LoadStorePerfTest(String name) {
        ...
        String newTableType = System.getProperty("com.mysql.jdbc.tests.test.tabletype");
    ...
    /**
     * Runs all tests in this tests.test case
     * 
     * @param args
     *            ignored
     * 
    ...
    /**
     * Runs one iteration of the tests.test.
     * 
    ...
    /**
     * Runs the tests.test 10 times to get JIT going, and GC going
     * 
     * @throws Exception
     *             if an error occurs.
     */
    protected void warmUp() throws Exception {
        try {
            ...
            System.out.println("\nUnits for this tests.test are transactions/sec.");
        } catch (Exception ex) {
            ex.printStackTrace();
