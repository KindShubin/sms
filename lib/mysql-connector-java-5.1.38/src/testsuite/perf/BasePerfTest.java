...
/**
 * Base class for performance tests.test cases. Handles statistics.
 */
public abstract class BasePerfTest extends BaseTestCase {
    ...
    /**
     * Adds one tests.test result to the statistics.
     * 
     * @param value
    ...
    protected void addResult(double value) {
        ...
        // Can only have confidence when more than one tests.test has been completed
        if (this.numIterations > 1) {
