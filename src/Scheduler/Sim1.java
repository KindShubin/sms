...
public class Sim1 implements Runnable{
    ...
    public Sim1(int sim_name, long imsi, int line_name){
    ...
    public void run() {
        try {
            ...
            //ct.setPriority(5);
            System.out.println(LogsT.printDate()+LogsId.id(IMSI)+"Run thread: "+ct.getName()+". sim_name:" + sim_name + " IMSI:" + IMSI + " line_name:" + line_name);
            System.out.println(LogsT.printDate()+LogsId.id(IMSI)+"Operator(): "+this.operator);
        }catch (Exception e){
            System.out.println(LogsT.printDate()+LogsId.id(IMSI)+e.toString());
        }
